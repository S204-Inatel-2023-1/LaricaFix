...
router.get('/receitas/ingrediente', async (req, res) => {
...
router.get('/receitas/instrucoes', async (req, res) => {
  const idPrato = req.query.id

  console.log('O id do prato em que se deseja pesquisar as instruções foi', idPrato.toLocaleString())
